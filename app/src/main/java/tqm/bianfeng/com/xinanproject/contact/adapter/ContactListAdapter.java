...
public class ContactListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContactListAdapter(Context mContext, List<String> mDatas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        String contactName = data.substring(0, data.indexOf("6"));
        final String phone = data.substring(data.indexOf("6"), data.length());

        mHolder.toastTxt.setText(contactName.substring(0, 1));
        mHolder.contactNameTxt.setText(contactName);
        ...
        mHolder.contactLin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentPhone = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+"0379" + phone));
